		...
		await message.reply({
			embeds: [
				this.container.client.utils
					...
					.setThumbnail(message.guild.iconURL({ dynamic: true, size: 4096 }) ?? "https://static.daangamesdg.xyz/discord/wumpus.png")
					.setFields([
						{
							name: "• Owner",
						...
						{
							name: "• Channels",
							value: `**Voice**: ${message.guild.channels.cache.filter((c) => c.isVoice()).size}\n**Text**: ${
